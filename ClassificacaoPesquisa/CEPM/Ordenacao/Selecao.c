...
typedef long ChaveTipo;  /*definição do tipo de chave long*/
typedef struct Item { /*definição da estrutura Item que contém uma chave*/
  ChaveTipo Chave;
  /* outros componentes */
} Item;

typedef int Indice; /*definição do Indice do tipo int*/
